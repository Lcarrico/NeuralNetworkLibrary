...
public class NeuralNetworkTests {
    ...
    /**
     * This test runs through NeuralNetworks.setNodes().
     * @see base.NeuralNetwork#setNodes(ArrayList)
     */
    @Test
    void setNodesTest(){
    ...
    /**
     * This test runs through NeuralNetwork.calc().
     * @see NeuralNetwork#calc(ArrayList)
     */
    @Test
    void calcTest(){
        ArrayList<ArrayList<Node>> nnNodes = new ArrayList<>();
    ...
    /**
     * This test runs through NeuralNetwork.calcAll().
     * @see NeuralNetwork#calcAll(ArrayList)
     */
    @Test
    void calcAllTest(){
        ArrayList<ArrayList<Node>> nnNodes = new ArrayList<>();
    ...
    /**
     * This test runs through NeuralNetwork.addLayers().
     *
     * @see NeuralNetwork#addLayers(Layer[])
     */
    @Test
    void addLayersTest(){
    ...
    /**
     * This test runs through NeuralNetwork.getNodes().
     * @see NeuralNetwork#getNodes()
     */
    @Test
    void getNodesTest(){
        NeuralNetwork<ArrayList<Integer>> nn = new NeuralNetwork<>();
    ...
    /**
     * This test runs through NeuralNetwork.clone().
     * @see NeuralNetwork#clone()
     */
    @Test
    void cloneTest(){
        NeuralNetwork<ArrayList<Integer>> nn = new NeuralNetwork<>();
    ...
    /**
     * This test runs through NeuralNetwork.toString().
     * @see NeuralNetwork#toString()
     */
    @Test
    void toStringTest(){
        NeuralNetwork<ArrayList<Integer>> nn = new NeuralNetwork<>();
